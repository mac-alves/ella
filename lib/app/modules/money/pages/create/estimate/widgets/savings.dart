        ...
        return Column(
          children: [
            ...
            SectionTitle(
              ...
              hasAction: true,
              action: Switch(
                value: controller.savings.selected,
                onChanged: (value) => controller.setEnableSavings(),
            ...
            MoneyInput(
              ...
              change: (value) => controller.savings.setValue(value),
              msgError: 'Digite um valor valido',
              error: controller.errorSavings,
              enable: controller.savings.selected,
              value: controller.savings.value,
            ),
          ],
        );
      }
